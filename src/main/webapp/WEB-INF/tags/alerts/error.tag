...
Example usage:
<b:error messageCode="error.message.code" />
--%>

<c:set var="hidden" value="${(empty visible) ? '' : (visible ? '' : 'hidden')}" />

<div id="${alertId}" class="alert alert-danger alert-dismissible fade in ${hidden}" role="alert">
	<div class="alert-icon">
		<span class="hr-icon__ban hr-icon-38 text-danger"></span>
	</div>
	<div class="alert-body">
		...
		<strong><spring:message code="system.messages.error" /></strong><br />
