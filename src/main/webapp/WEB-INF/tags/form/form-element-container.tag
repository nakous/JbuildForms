...
<%@ attribute name="shortlabel" type="java.lang.Boolean" required="false"%>
...
<c:set var="shortlavel" value="${(empty shortlabel) ? false : shortlabel}"/>
<c:set var="elementCssClass" value="${(shortlavel) ? 'col-lg-4' : 'col-lg-7'}"/>
