...
<c:choose>
	<c:when test="${question.type == 'field' && question.appearence == 'start-date'}">
		<script>
		...
		>
			...
			<div class="text-danger hidden col-md-12" id="answerSheet.answers${question.id}.values.error.text">
				<small><spring:message code="field.is.empty"/></small>
			</div>
			<div class="text-warning hidden col-md-12" id="answerSheet.answers${question.id}.values.warning.text">
				<small></small>
			</div>
